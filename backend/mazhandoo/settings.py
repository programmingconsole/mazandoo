...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-mazhandoo-default-secret')
...
WSGI_APPLICATION = 'mazhandoo.wsgi.application'
...
# GPS radius reporting config (in meters)
WEATHER_REPORT_RADIUS_METERS = 2000
